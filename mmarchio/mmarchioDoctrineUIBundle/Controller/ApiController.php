...
namespace mmarchio\mmarchioDoctrineUIBundle\Controller;
...
use mmarchio\mmarchioDoctrineUIBundle\Entity\Collector;
...
class ApiController extends Controller
{
    ...
    public function createTable(Request $request)
    {
        ...
        if (!empty($request->getContent())) {
            ...
            $payload->entityName = "mmarchio/mmarchioDoctrineUIBundle:".$request->get("table_name");
        ...
        return $this->render('@doctrineUI/tables.html.twig', ["data" => $data]);
    }
    ...
    public function createEntityTestAction()
    {
        $o = new \stdClass();
        $o->tableName = "test";
        $o->entityName = "mmarchio/mmarchioDoctrineUIBundle:test";
        $o->format = "annotation";
        $o->fields = [];
        $field = new \stdClass();
        $field->name = "test";
